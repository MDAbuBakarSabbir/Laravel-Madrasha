...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            {{-- <div class="logo">
                <a href="{{route('home')}}" class="logo-icon"><span class="logo-text">AL-Itqan</span></a>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href=""><i class="fa-solid fa-user-tie"></i>Teachers<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="pricing.html">Add Teacher</a>
                            </li>
                            <li>
                                <a href="invoice.html">Teachers List</a>
                            </li>
                            {{-- <li>
                    ...
                    <li>
                        <a href=""><i class="fa-solid fa-user-graduate"></i>Students<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="pricing.html">Add Student</a>
                            </li>
                            <li>
                                <a href="invoice.html">Students List</a>
                            </li>
                            {{-- <li>
                                <a href="settings.html">Settings</a>
                            </li>
                    ...
                    <li>
                        <a href=""><i class="fa-solid fa-bangladeshi-taka-sign"></i>Payments<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="pricing.html">Add Student</a>
                            </li>
                    ...
                    <li class="active-page">
                        <a href="index.html" class="active"><i class="fa-solid fa-file-lines"></i>Notice</a>
                    </li>
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><img src="{{asset('dashboard')}}/assets/images/flags/us.png" alt=""></a>
                                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                                            <li><a class="dropdown-item" href="#"><img src="{{asset('dashboard')}}/assets/images/flags/germany.png" alt="">German</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="{{asset('dashboard')}}/assets/images/flags/italy.png" alt="">Italian</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="{{asset('dashboard')}}/assets/images/flags/china.png" alt="">Chinese</a></li>
                                        </ul>
                                </li>
                                <li class="nav-item hidden-on-mobile">
                                                ...
                                                <div class="notifications-dropdown-item">
                                                    <div class="notifications-dropdown-item-image">
                                                        <span class="notifications-badge">
                                                            <img src="{{asset('dashboard')}}/assets/images/avatars/avatar.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div class="notifications-dropdown-item-text">
                ...
                <div class="content-wrapper">
                    <div class="container">
                                        ...
                                        <div class="widget-payment-request-container">
                                            ...
                                            <div class="widget-payment-request-product">
                                                <div class="widget-payment-request-product-image m-r-sm">
                                                    <img src="{{asset('dashboard')}}/assets/images/other/facebook_logo.png" class="mt-auto" alt="">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-product-container">
                                            <div class="widget-popular-product-image">
                                                <img src="{{asset('dashboard')}}/assets/images/widgets/popular-product.jpeg" alt="">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card">
                                    <img src="{{asset('dashboard')}}/assets/images/widgets/blog5.jpeg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card widget widget-info">
                                    <div class="card-body">
                                        <div class="widget-info-container">
                                            <div class="widget-info-image" style="background: url('{{asset('dashboard')}}/assets/images/widgets/security.svg')"></div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-blog-container">
                                            <div class="widget-popular-blog-image">
                                                <img src="{{asset('dashboard')}}/assets/images/widgets/product2.jpeg" alt="">
                                            </div>
